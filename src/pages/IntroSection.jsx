...
const IntroSection = () => {
  return (
    <section
      className="secondBG h-[110vh] lg:h-[140vh] flex flex-col justify-center relative"
      id="introSection"
    >
      <div className="px-5 lg:pl-[50px] lg:mt-16 md:text-center lg:text-left">
        <h2 className="font-medium text-[48px] leading-[45px] mt-10 lg:mt-0 mb-5 lg:mb-0">
          Introducing Odin.
        </h2>
        <p className="text-[20px] font-medium my-3 lg:my-7">
        ...
        <div className="md:text-center lg:text-left text-[17px] font-medium mt-10 lg:mt-0">
          <Link
            to="#"
